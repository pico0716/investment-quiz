...
const RESULTS = {
  'long-tech': {
    ...
    description:
      'AIやテクノロジーの長期的な成長に期待し、数年〜10年という長いスパンで保有していくスタイルです。日々の値動きより、企業がこれから生み出す価値に目を向けます。短期の変動に一喜一憂せず、じっくり育てる感覚が向いています。',
    recommend: '国内外のテクノロジー・AI関連株、テクノロジーセクターのインデックスファンドなど',
    cta: {
  ...
  'long-infra': {
    ...
    description:
      '電力・通信・食品など、生活に欠かせない企業の安定した配当を重視するスタイルです。大きな値上がりより、長く持ち続けて受け取る配当収入に魅力を感じるタイプです。景気の波に比較的左右されにくい銘柄を軸に据えるのが特徴です。',
    recommend: '生活インフラ・公益系の高配当株、連続増配株、高配当ETFなど',
    cta: {
  ...
  'long-global': {
    ...
    description:
      '特定の国や企業に絞らず、米国や全世界に幅広く分散して長期で保有するスタイルです。世界経済全体の成長をリターンの源泉と考え、低コストのインデックスファンドを活用する方法が代表的です。手間をかけずにコツコツ積み立てたい方に合っています。',
    recommend: '全世界株・米国株のインデックスファンド（低コストの投資信託・ETF）など',
    cta: {
  ...
  'long-esg': {
    ...
    description:
      '環境や社会課題の解決に取り組む企業を、長期で応援するスタイルです。リターンと同じくらい「どんな未来に投資するか」を大切にします。自分の価値観と投資先を一致させることで、持ち続けるモチベーションにもつながります。',
    recommend: 'ESG・脱炭素・再生可能エネルギー関連のテーマ株やESGファンドなど',
    cta: {
  ...
  'short-tech': {
    ...
    description:
      'AIやテクノロジーの話題で動く株を、比較的短い期間で売買していくスタイルです。値動きの大きさを機会と捉え、タイミングを意識した取引が中心になります。利益を狙える反面、損失リスクも高くなるため、資金管理とルール作りが重要です。',
    recommend: '値動きの大きいテック・グロース系の株式（※リスク管理が前提）',
    cta: {
  ...
  'short-infra': {
    ...
    description:
      '生活インフラ系の銘柄を、比較的短い期間で売買していくスタイルです。身近な産業の値動きを機会と捉えるため、ニュースや業績発表に敏感に反応できると強みになります。短期売買は利益と損失の両方が早く動くため、リスク管理を前提に臨むことが大切です。',
    recommend: '出来高のある国内インフラ・素材・エネルギー関連株（※リスク管理が前提）',
    cta: {
  ...
  'short-global': {
    ...
    description:
      '米国指数や為替の動きをもとに、比較的短い期間で売買していくスタイルです。グローバルな経済ニュースや金利動向を読む力が活きてきます。短期売買はリスクも伴うため、余裕資金の範囲内で取り組むことが基本です。',
    recommend: '米国株・グローバル指数連動商品、為替の影響を受ける輸出関連株など（※リスク管理が前提）',
    cta: {
  ...
  'short-esg': {
    ...
    description:
      '環境・社会のトレンドで動くテーマ株を、比較的短い期間で売買していくスタイルです。政策や国際動向などの話題性のある変化をいち早くキャッチする視点が活きます。短期売買はリスクも伴うため、資金管理を徹底したうえで取り組むことが大切です。',
    recommend: '脱炭素・再生エネルギー・社会課題解決などテーマ性のある株式（※リスク管理が前提）',
    cta: {
